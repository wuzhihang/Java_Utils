...
public class TimeUtil {
	...
	public static List<String> getDateListByRange(String startDate, String endDate, String pattern) {
		...
		if(StringUtils.isNotBlank(startDate) && StringUtils.isNotBlank(endDate)){
			...
			calendarStart.setTime(TimeUtil.getStringToDate(startDate, pattern));
			Calendar calendarEnd = Calendar.getInstance();
			calendarEnd.setTime(TimeUtil.getStringToDate(endDate, pattern));

			while (!calendarStart.after(calendarEnd)) {
				dates.add(TimeUtil.getDateToString(calendarStart.getTime(), pattern));
	...
	public static List<String> getMonthListByRange(String startDate, String endDate) {
		...
		while (!calendarStart.after(calendarEnd)) {
			months.add(TimeUtil.getDateToString(calendarStart.getTime(), format));
	...
	public static Date getLastDayOfMonth(String month){
		Date date = getStringToDate(month, "yyyy-MM");
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
		calendar.set(Calendar.DAY_OF_MONTH, 1);
		calendar.add(Calendar.MONTH, 1);
	...
	public static void main(String[]  args){
		System.out.println(getDateListByRange(null, null, "yyyyMMdd"));
	}
